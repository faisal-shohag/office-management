                ...
                <TooltipProvider>
                    <main className="">
                        <Tabs defaultValue="all">
                            <div className="flex items-center">
                                ...
                                <span className="sr-only sm:not-sr-only sm:whitespace-nowrap">
                                    ...
                                    <Button size="sm" className="h-8 gap-1">
                                        ...
                                        <Link to='/add-staffs' className="sr-only sm:not-sr-only sm:whitespace-nowrap">
                                            Add Staffs
                                        </Link>
                                    </Button>
                                </div>
                            ...
                            {
                                staffs.length == 0 ? <Alert title="You have not added any Staffs yet!" subtitle="Here you can manage teachers!" link="/add-staffs" linktitle="Add" /> : <div>
